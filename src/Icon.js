...
function LogoIcon({size, fill}) {
  return (
    <Svg
      ...
      <Path d="M350 0H0V100H350V0Z" fill={fill} />
      <Path d="M225 125H125V350H225V125Z" fill={fill} />
      <Path d="M750 0V225H400V125H650V100H400V0H750Z" fill={fill} />
      <Path d="M500 250H400V350H500V250Z" fill={fill} />
      <Path d="M750 350H525V250H650L750 350Z" fill={fill} />
      <Path d="M1150 0H800V100H1150V0Z" fill={fill} />
      <Path d="M1150 250V350H800V250H925V125H1025V250H1150Z" fill={fill} />
      <Path d="M1550 0V225H1200V125H1450V100H1200V0H1550Z" fill={fill} />
      <Path d="M1300 250H1200V350H1300V250Z" fill={fill} />
    </Svg>
  );
}
...
function AccountIcon({size, fill}) {
  return (
    <Svg
      width={size}
      height={size}
...
function FacebookIcon({size, fill}) {
  return (
    <Svg
      width={size}
      height={size}
...
function LocationIcon({size, fill}) {
  return (
    <Svg
      width={size}
      height={size}
